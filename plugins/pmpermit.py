    ...
    if PMPERMIT == "ENABLE":
        if PMSET:
            ...
            await SAMMY.send_message(
                message.chat.id,
                "Hi there, This is a music assistant service .\n\n ❗️ Rules:\n   - No chatting allowed\n   - No spam allowed \n\n 👉 **SEND YOUR GROUP INVITE LINK OR USERNAME HERE @pratheek06 IF USERBOT CAN'T JOIN YOUR GROUP.**\n\n ⚠️ Disclamer: If you need any help then join support group :- @SHIZUKA_VC_SUPPORT\n    - Don't add this user to secret groups.\n   - Don't Share private info here\n\n",
            )
            return

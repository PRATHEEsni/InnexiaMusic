...
async def play(_, message: Message):
    ...
    try:
        ...
        await lel.edit(
            f"<i> {user.first_name} Userbot not in this chat, Ask admin to send /play command for first time or add {user.first_name} manually request here @SHIZUKA_VC_SUPPORT with your group link</i>"
        )
        return
    text_links=None
...
async def jiosaavn(client: Client, message_: Message):
    ...
    try:
        ...
        await lel.edit(
            "<i> helper Userbot not in this chat, Ask admin to send /play command for first time or add assistant manually request here @SHIZUKA_VC_SUPPORT with your group link</i>"
        )
        return
    requested_by = message_.from_user.first_name
    chat_id = message_.chat.id
